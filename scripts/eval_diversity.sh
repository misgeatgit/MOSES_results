...
for p in $(uniq_prefixes "$exp_dir/anal/" "_cnd_*_train.csv"); do
    CMD="/home/addis-ai/opencog_ocpkg/opencog/build/opencog/learning/moses/main/eval-diversity -u f280 --display-stats 1 --diversity-dst tanimoto"  #my modification(Misgana) changed value of -u from out to f280
